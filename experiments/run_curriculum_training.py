...
if __name__ == "__main__":
    model1, tokenizer1 = load_model_and_tokenizer(Namespace(model="phi-2"))

    model2, tokenizer2 = load_model_and_tokenizer(Namespace(model="phi-2")) # redefine a small trasnformer with the same size but less blocks
